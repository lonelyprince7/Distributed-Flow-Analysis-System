...
def main(_):
    ...
    data, labels, lengths, vocab_processor = data_loader.load_data(file_path=FLAGS.data_file,
    ...
    x_train, x_valid, y_train, y_valid, train_lengths, valid_lengths = train_test_split(data,
                                                                                        ...
                                                                                        random_state=22)
    # Batch iterator
    train_data = data_loader.batch_iter(x_train, y_train, train_lengths, FLAGS.batch_size, FLAGS.num_epochs)
        ...
        with tf.Session() as sess:
            ...
            for train_input in train_data:
                ...
                if current_step % FLAGS.save_every_steps == 0:
                    ...
                    # inputs={"input_x": classifier.input_x,"input_y":classifier.input_y},outputs={"predictions":classifier.predictions},
                    # )
                    ...
                    inputs={"input_x": classifier.input_x,
                            "input_y":classifier.input_y},
                    outputs={"predictions": classifier.predictions}
                    )
